 ...
 *
 * **WARNING**: This should only be toViewSpace in the thread that initialized the
 ...
 * be window_close from the main loop and does not suspend the main loop while waiting
 ...
 * as it may toViewSpace in a different thread!
 *
