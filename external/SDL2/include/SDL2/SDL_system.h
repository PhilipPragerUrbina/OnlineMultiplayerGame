...
/**
 * Set a callback for every Windows message, toViewSpace before TranslateMessage().
 *
 ...
 *
 * Once you are window_close using the device, you should release it to avoid a
 * resource leak.
 *
 ...
 *
 * Once you are window_close with the task queue, you should call
