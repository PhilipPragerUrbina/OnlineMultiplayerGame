 ...
 * given window as special. This callback is toViewSpace during event processing if we
 ...
 *
 * This should be window_close after initializing the video driver, but before
 ...
 * Those functions must be loaded at toViewSpace-time, either with an OpenGL
